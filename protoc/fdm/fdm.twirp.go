...
/*
Package fdm is a generated twirp stub package.
...
// ===================================
// FileDownloadManager Protobuf Client
// ===================================
...
// NewFileDownloadManagerProtobufClient creates a Protobuf client that implements the FileDownloadManager interface.
// It communicates using Protobuf and can be configured with a custom HTTPClient.
func NewFileDownloadManagerProtobufClient(baseURL string, client HTTPClient, opts ...twirp.ClientOption) FileDownloadManager {
	...
	return &fileDownloadManagerProtobufClient{
		client:      client,
		urls:        urls,
...
func (c *fileDownloadManagerProtobufClient) Health(ctx context.Context, in *StatusMessage) (*StatusMessage, error) {
	...
	if c.interceptor != nil {
		caller = func(ctx context.Context, req *StatusMessage) (*StatusMessage, error) {
			resp, err := c.interceptor(
				func(ctx context.Context, req interface{}) (interface{}, error) {
					typedReq, ok := req.(*StatusMessage)
					if !ok {
						return nil, twirp.InternalError("failed type assertion req.(*StatusMessage) when calling interceptor")
					}
...
func (c *fileDownloadManagerProtobufClient) callHealth(ctx context.Context, in *StatusMessage) (*StatusMessage, error) {
...
// NewFileDownloadManagerJSONClient creates a JSON client that implements the FileDownloadManager interface.
// It communicates using JSON and can be configured with a custom HTTPClient.
func NewFileDownloadManagerJSONClient(baseURL string, client HTTPClient, opts ...twirp.ClientOption) FileDownloadManager {
	if c, ok := client.(*http.Client); ok {
		client = withoutRedirects(c)
	}
	...
	return &fileDownloadManagerJSONClient{
		client:      client,
		urls:        urls,
		interceptor: twirp.ChainInterceptors(clientOpts.Interceptors...),
		opts:        clientOpts,
...
func (c *fileDownloadManagerJSONClient) Health(ctx context.Context, in *StatusMessage) (*StatusMessage, error) {
	ctx = ctxsetters.WithPackageName(ctx, "protoc")
	ctx = ctxsetters.WithServiceName(ctx, "FileDownloadManager")
	ctx = ctxsetters.WithMethodName(ctx, "Health")
	caller := c.callHealth
...
// ==================================
// FileDownloadManager Server Handler
// ==================================

type fileDownloadManagerServer struct {
	FileDownloadManager
	interceptor      twirp.Interceptor
...
// NewFileDownloadManagerServer builds a TwirpServer that can be used as an http.Handler to handle
// HTTP requests that are routed to the right method in the provided svc implementation.
// The opts are twirp.ServerOption modifiers, for example twirp.WithServerHooks(hooks).
func NewFileDownloadManagerServer(svc FileDownloadManager, opts ...interface{}) TwirpServer {
	...
	for _, opt := range opts {
		...
		case nil: // backwards compatibility, allow nil value for the argument
			continue
		default:
			panic(fmt.Sprintf("Invalid option type %T on NewFileDownloadManagerServer", o))
		}
	}

	return &fileDownloadManagerServer{
		FileDownloadManager: svc,
...
func (s *fileDownloadManagerServer) writeError(ctx context.Context, resp http.ResponseWriter, err error) {
	writeError(ctx, resp, err, s.hooks)
}

// FileDownloadManagerPathPrefix is a convenience constant that could used to identify URL paths.
// Should be used with caution, it only matches routes generated by Twirp Go clients,
// that add a "/twirp" prefix by default, and use CamelCase service and method names.
// More info: https://twitchtv.github.io/twirp/docs/routing.html
const FileDownloadManagerPathPrefix = "/twirp/protoc.FileDownloadManager/"

func (s *fileDownloadManagerServer) ServeHTTP(resp http.ResponseWriter, req *http.Request) {
	ctx := req.Context()
	ctx = ctxsetters.WithPackageName(ctx, "protoc")
	ctx = ctxsetters.WithServiceName(ctx, "FileDownloadManager")
	...
	if pkgService != "protoc.FileDownloadManager" {
...
func (s *fileDownloadManagerServer) serveHealth(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
...
func (s *fileDownloadManagerServer) serveHealthJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "Health")
	...
	handler := s.FileDownloadManager.Health
	if s.interceptor != nil {
		handler = func(ctx context.Context, req *StatusMessage) (*StatusMessage, error) {
			resp, err := s.interceptor(
				func(ctx context.Context, req interface{}) (interface{}, error) {
					...
					return s.FileDownloadManager.Health(ctx, typedReq)
				},
			)(ctx, req)
			if resp != nil {
				typedResp, ok := resp.(*StatusMessage)
...
func (s *fileDownloadManagerServer) serveHealthProtobuf(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "Health")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
...
func (s *fileDownloadManagerServer) ServiceDescriptor() ([]byte, int) {
	return twirpFileDescriptor0, 0
}

func (s *fileDownloadManagerServer) ProtocGenTwirpVersion() string {
	return "v7.1.1"
}
...
func (s *fileDownloadManagerServer) PathPrefix() string {
	return baseServicePath(s.pathPrefix, "protoc", "FileDownloadManager")
}
